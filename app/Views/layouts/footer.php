    ...
    <div class="relative p-4 !top-10 w-full max-w-xl max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-2 md:p-3 border-b rounded-t">
                <h3 id="modal-title" class="text-md font-medium capitalize text-gray-900"></h3>
                <button id="close-modal-button" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
