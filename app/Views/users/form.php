...
<form class="p-2 md:p-3">
    <div class="grid gap-2 mb-4 grid-cols-2">
        <div class="col-span-2">
            ...
            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-[4px] focus:!ring-gozi-400 block w-full p-2.5" placeholder="example: 22519/1990.063" required="">
        </div>
        <div class="col-span-2">
        ...
        <div class="col-span-2">
            ...
            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-[4px] focus:!ring-gozi-400 block w-full p-2.5" placeholder="example: $2a$12$ar.A3NtxJibqJuH24vEvT" required="">
        </div>
    </div>
